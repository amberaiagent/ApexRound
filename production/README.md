...
- One shared main timer: 30 minutes of registration, then 24-hour trading rounds. Later registration opens in the current round's final hour. UTC durations remain exact across daylight-saving changes; displayed dates also show ET and local time.
