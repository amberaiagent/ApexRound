...
import { REQUIRED_ACCESS_TOKENS } from './access-policy.js?v=arena-access-5m-20260914';
...
export const config = Object.freeze({
  demo: false,
  ticker: '$ARENA',
  required: REQUIRED_ACCESS_TOKENS,
...
export const pending = [
  ...
  'Whether 5M $ARENA must be held throughout the round',
